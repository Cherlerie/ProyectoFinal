    ...
    return rx.card(
        rx.hstack(
            ...
            rx.vstack(
                rx.hstack(
                    rx.badge(
                        rx.text("9,7", font_weight="bold", color="white"),
                        background="#2563eb",
                        px="3",
                        py="1",
                        border_radius="4px"
                    ...
                    rx.vstack(
                        rx.text("Cayo Levantado", font_weight="bold", size="2"),
                        rx.text("2,100 comentarios", size="1", color="gray.600"),
                        spacing="0",
                        align="start"
                    ),
                    spacing="3",
                ...
                rx.hstack(
                    ...
                    rx.hstack(
                        rx.icon("boat", size=16, color="blue.500"),
                        rx.text("Acceso en bote", size="2"),
                        spacing="1"
                    ),
                    spacing="4"
                ),
                ...
                rx.box(
                    rx.text(
                        "Disfruta de la isla más famosa de Samaná. Cayo Levantado te espera con playas de arena blanca, aguas turquesas, palmeras y un ambiente relajante ideal para descansar y disfrutar del Caribe.",
                        size="2",
                        color="blue.700",
                        font_weight="medium"
                    ),
...
def reservation_sidebar():
    return rx.vstack(
        rx.box(
            ...
            rx.vstack(
                rx.vstack(
                    ...
                    rx.text("2 de agosto", font_weight="bold", color="blue.600", size="2", display="inline"),
                    rx.text(" de 2025 desde las 09:30", color="gray.700", size="2", display="inline"),
                    spacing="1",
                    align="start"
                ),
                rx.vstack(
        ...
        rx.box(
            ...
            rx.vstack(
                rx.hstack(
                    rx.text("Tour Cayo Levantado (por persona)", size="2"),
                    rx.text("DOP 1,800.00", font_weight="bold", size="2"),
                    justify="between",
                    width="100%"
                ),
                rx.vstack(
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("USD 30.00", font_weight="bold", size="2"),
                        justify="between",
                        width="100%"
                    ),
                    rx.text("(incluye transporte en bote, acceso a la isla y almuerzo)", color="gray.500", size="1", align="left"),
                    spacing="0",
                    align="start",
                    width="100%"
                ),
        ...
        rx.box(
            ...
            rx.vstack(
                rx.text(
                    "Cancelación gratis hasta las 23:59 del 30 de julio de 2025",
                    color="green.600",
                    font_weight="medium",
                    size="2"
                ),
                rx.text(
                    "A partir de las 00:00 del 31 de julio DOP 1,800.00 no reembolsable",
                    color="gray.700",
                    size="2"
                ),
                spacing="2",
