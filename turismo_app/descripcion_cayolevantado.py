...
class PropertyState(rx.State):
    ...
    title: str = "Cayo levantado"
    rating: float = 4.4
    reviews: int = 741
    location: str = "Cayo Levantado, 32000 Samana, República Dominicana"
    location_quality: str = "Hermosa Ubicación"
    map_score: float = 8.8
    guest_review: str = "Hermosa Isla con area blanca y agua cristalina."
    guest_name: str = "Lucia"
    guest_country: str = "Chile "
    personal_rating: float = 8.5

    description: str = "Cayo Levantado, también conocido como Isla Bacardí, es un pequeño islote en la bahía de Samaná famoso por sus playas de arena blanca y aguas turquesa. El lugar cuenta con instalaciones turísticas como restaurantes, bares y zonas de descanso."
    room_description: str = "Es posible llegar en bote desde Samaná y se ofrecen excursiones diarias que incluyen tiempo libre para nadar, tomar el sol y practicar snorkel. Es una parada obligatoria para quienes visitan la región noreste del país."
    breakfast_info: str = ""
    location_info: str = ""
    
    main_image: str = "https://www.barcelo.com/guia-turismo/wp-content/uploads/cayo-levantado.jpg"
    images: List[str] = [
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/04/98/bc/img-20190319-wa0085-largejpg.jpg?w=900&h=500&s=1",
        "https://www.lopesancostabavaro.com/wp-content/uploads/2021/03/2-3.jpg",
        "https://puntacanaexcursions.online/wp-content/uploads/2023/01/Excursion-cayo-levantado-desde-punta-cana.jpg",
        "https://images.trvl-media.com/lodging/1000000/200000/196800/196715/60bfe16a.jpg?impolicy=resizecrop&rw=575&rh=575&ra=fill ",
        "https://cf.bstatic.com/xdata/images/hotel/max1024x768/464990579.jpg?k=f57ddda7020fd5d13e2aac73e2a91629db3803c5da3d714a230196b16c0b140e&o=&hp=1",
        "https://i0.wp.com/ensegundos.do/wp-content/uploads/2024/11/hotel-bahia-principe-cayo-levantado-samana-republica-dominicana-1200x860-1.jpg?fit=1200%2C860&quality=70&ssl=1",
    ]
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.button(
                    ...
                    color_scheme="blue",
                    size="3",
                    on_click=lambda: rx.redirect("/reserva_cayo")
                ),
                spacing="2"
            ),
            width="100%"
...
def reviews_section() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.box(
                rx.image(
                    src="https://tandemtalent.es/wp-content/uploads/2016/11/Luc%C3%ADa-Caraballo-2839.jpg",
                    border_radius ="100px",
                    width = "40px"
                ),
                bg="blue.500",
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.text("Especies naturales de peces", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
                rx.icon("sunrise", size=16, color="teal"),
                rx.text("Hermosos paisajes", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
                rx.icon("bed", size=16, color="teal"),
                rx.text("Hoteles", size="2"),
                spacing="2",
                align="center"
            ),
            spacing="6",
...
def amenities_sidebar() -> rx.Component:
    ...
    return rx.vstack(
        ...
        # Vistas
        rx.hstack(
            rx.icon("zap", size=20, color="gray.600"),
            rx.vstack(
                rx.text(
                ...
                rx.text(
                    "Cargadores disponibles en el alojamiento",
                    size="2",
                    color="gray.600"
                ),
                spacing="0",
