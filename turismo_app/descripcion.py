...
class PropertyState(rx.State):
    ...
    title: str = "RIG Colonial Experience"
    rating: float = 4.1
    reviews: int = 586
    location: str = "118 Calle Espaillat, Zona Colonial, 10210 Santo Domingo, República Dominicana"
    location_quality: str = "Muy buena ubicación"
    map_score: float = 8.1
    guest_review: str = "Muy cómoda, limpia, bien ubicada el personal atento"
    guest_name: str = "Josefa"
    guest_country: str = "Colombia"
    personal_rating: float = 8.9
    
    description: str = "RIG Colonial Experience es un alojamiento bien situado en Santo Domingo que ofrece piscina al aire libre, wifi gratis, terraza y habitaciones con aire acondicionado. Este hotel de 3 estrellas ofrece servicio de habitaciones y recepción 24 horas. El alojamiento dispone de traslado para ir y volver del aeropuerto y también hay servicio de alquiler de bicicletas."
    room_description: str = "En el hotel, cada habitación cuenta con escritorio, TV de pantalla plana, baño privado, ropa de cama y toallas. Las habitaciones incluyen caja fuerte y algunas también ofrecen balcón. Las unidades disponen de armario."
    breakfast_info: str = "En RIG Colonial Experience se sirve un desayuno buffet."
    location_info: str = "Cerca del alojamiento hay puntos de interés como Playa Montesinos, Puerto de Santo Domingo y Malecón. El aeropuerto (Aeropuerto Internacional La Isabela) está a 19 km."
    
    main_image: str = "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop"
    images: List[str] = [
        ...
        "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=200&h=150&fit=crop",
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.text("Piscina al aire libre", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
                rx.icon("plane", size=16, color="teal"),
                rx.text("Traslado aeropuerto", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
                rx.icon("droplets", size=16, color="teal"),
                rx.text("Habitaciones sin humo", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
                rx.icon("bed", size=16, color="teal"),
                rx.text("Servicio de habitaciones", size="2"),
                spacing="2",
                align="center"
            ),
            spacing="6",
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.text("Recepción 24 horas", size="2"),
                spacing="2",
                align="center"
            ),
            rx.hstack(
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.vstack(
                ...
                rx.text(
                    "TV de pantalla plana. Aire acondicionado. Servicio de streaming (como Netflix)",
                    size="2",
                    color="gray.600",
                    line_height="1.4"
                ),
        ...
        rx.hstack(
            ...
            rx.vstack(
                ...
                rx.text(
                    "Balcón. Vistas a un patio interior",
                    size="2",
                    color="gray.600"
                ),
                spacing="0",
        ...
        rx.hstack(
            rx.icon("car", size=20, color="gray.600"),
            rx.vstack(
                rx.text(
                    "Servicio de traslado",
                    font_weight="bold",
                ...
                rx.text(
                    "Traslado aeropuerto. Servicio de traslado",
                    size="2",
                    color="gray.600"
                ),
                spacing="0",
