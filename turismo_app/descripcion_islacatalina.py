...
class PropertyState(rx.State):
    ...
    title: str = "Isla Catalina"
    rating: float = 4.8
    reviews: int = 661
    location: str = "Isla Catalina, 22000 La Romana, República Dominicana"
    location_quality: str = "Hermosa Ubicación"
    map_score: float = 8.2
    guest_review: str = "Hermosa isla con playas de arena blanca y aguas cristalinas. Ideal para un día de tranquilidad."
    guest_name: str = "Marta"
    guest_country: str = "Argentina"
    personal_rating: float = 8.1

    description: str = "La Isla Catalina se encuentra frente a las costas de La Romana y es un destino popular para el buceo y el snorkel gracias a sus arrecifes de coral. Con playas tranquilas y zonas designadas para el turismo, la isla cuenta con servicio de transporte en catamarán, áreas de descanso con sombra y servicio de comida."
    room_description: str = "Además de su belleza natural, alberga restos arqueológicos submarinos. Es un lugar ideal para excursiones de un día y actividades acuáticas."
    breakfast_info: str = ""
    location_info: str = ""
    
    main_image: str = "https://upload.wikimedia.org/wikipedia/commons/e/e9/Dominicana-Isla_Catalina2.jpg"
    images: List[str] = [
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2a/95/c1/dc/caption.jpg?w=900&h=500&s=1",
        "https://www.bahia-principe.com/content/image/m/1418233901146/catalina-island.jpg",
        "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/12/e7/de/d3.jpg",
        "https://tainotour.com/wp-content/uploads/2021/03/Recublica-dominicana-munter-magazine-1.jpg",
        "https://www.puntacanatravelblog.com/wp-content/uploads/dominican_republic_087_isla_catalina.jpg",
        "https://cdn.tourcms.com/a/13222/915/3/large.jpg",
    ]
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.button(
                    ...
                    color_scheme="blue",
                    size="3",
                    on_click=lambda: rx.redirect("/reserva_isla")
                ),
                spacing="2"
            ),
            width="100%"
