        ...
        rx.hstack(
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.vstack(
                        rx.text("Acuario Nacional RD", font_weight="bold", size="2"),
                        rx.text("2,300 comentarios", size="1", color="gray.600"),
                        spacing="0",
                        align="start"
                    ),
                    spacing="3",
                ...
                rx.hstack(
                    rx.hstack(
                        rx.icon("fish", size=16, color="blue.500"),
                        rx.text("Túnel submarino", size="2"),
                        spacing="1"
                    ),
                    rx.hstack(
                        rx.icon("waves", size=16, color="teal.500"),
                        rx.text("Vista al mar Caribe", size="2"),
                        spacing="1"
                    ),
                    spacing="4"
                ),
                rx.hstack(
                    ...
                    rx.text(
                        "Av. España, Santo Domingo Este, República Dominicana",
                        size="2",
                        color="gray.700"
                    ),
                    spacing="1",
                ...
                rx.box(
                    rx.text(
                        "Descubre la vida marina del Caribe en el Acuario Nacional. Disfruta de exhibiciones interactivas, túnel submarino, jardines y vistas espectaculares al mar.",
                        size="2",
                        color="blue.700",
                        font_weight="medium"
                    ),
...
def reservation_sidebar():
    return rx.vstack(
        rx.box(
            ...
            rx.vstack(
                rx.vstack(
                    ...
                    rx.text("21 de junio", font_weight="bold", color="blue.600", size="2", display="inline"),
                ...
                rx.vstack(
                    ...
                    rx.text("4 horas", color="gray.700", size="2"),
                    spacing="1",
                    align="start"
                ),
                spacing="4",
        ...
        rx.box(
            ...
            rx.vstack(
                rx.hstack(
                    rx.text("Entrada general Acuario Nacional", size="2"),
                    rx.text("DOP 350.00", font_weight="bold", size="2"),
                    justify="between",
                    width="100%"
                ),
                rx.vstack(
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("USD 6.00", font_weight="bold", size="2"),
                        justify="between",
                        width="100%"
                    ),
                    rx.text("(incluye acceso a todas las exhibiciones)", color="gray.500", size="1", align="left"),
                    spacing="0",
                    align="start",
                    width="100%"
                ),
        ...
        rx.box(
            ...
            rx.vstack(
                rx.text(
                    "Cancelación gratis hasta las 23:59 del 19 de junio de 2025",
                    color="green.600",
                    font_weight="medium",
                    size="2"
                ),
                rx.text(
                    "A partir de las 00:00 del 20 de junio DOP 350.00 no reembolsable",
                    color="gray.700",
                    size="2"
                ),
                spacing="2",
...
def contact_form():
    return rx.container(
        rx.vstack(
            ...
            rx.vstack(
                rx.text("¿Visita educativa o recreativa?", font_weight="bold", size="3"),
                rx.radio_group(
                    ["Educativa", "Recreativa"],
                    default_value="Recreativa",
                    direction="row",
                    spacing="3"
                ),
                align_items="start",
